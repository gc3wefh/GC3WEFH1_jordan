...
st.title("ML Readiness App with Enhanced Report Sizes")
...
if uploaded_file is not None:
    ...
    # Make the button for generating Sweetviz report larger
    ...
    st.dataframe(working_df.describe())
    ...
    st.dataframe(pd.DataFrame(z_scores, columns=working_df.columns).head())
